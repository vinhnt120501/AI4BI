          ...
          <thead className="sticky top-0 z-10">
            <tr className="bg-slate-50/80 backdrop-blur-sm">
              {columns.map((col, i) => (
                <th
                  key={i}
                  className="px-4 py-2.5 text-[11px] font-semibold text-slate-400 uppercase tracking-wider border-b border-slate-100 whitespace-nowrap"
                >
                  {col.label || col.key}
                </th>
              ))}
            ...
            {rows.map((row, ri) => (
              ...
              >
                {columns.map((col, ci) => {
                  ...
                  return (
                    <td key={ci} className="px-4 py-2.5 whitespace-nowrap text-[13px]">
