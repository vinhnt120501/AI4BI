# Push `web_app_v4` lên GitHub (nhánh `vinhnt_ver_2`) — không push `.env`, không ghi đè nội dung có sẵn

## Mục tiêu
- Đẩy source code của thư mục `web_app_v4/` lên repo GitHub `vinhntnt120501/AI4BI`, nhánh `vinhnt_ver_2`.
