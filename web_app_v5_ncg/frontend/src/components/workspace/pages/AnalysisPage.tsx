...
export default function AnalysisPage({ busy, messages, query, onSend, onSelectHistory, instructionPanelOpen = true, isMcpConfigured }: AnalysisPageProps) {
  ...
  }, [loadLandingSuggestions, loadRecentQuestions, isMcpConfigured]);
              ...
              <div className="flex w-full min-h-0 max-w-[1000px] flex-col overflow-hidden">
                <div className="mb-4 flex-shrink-0">
                  <div className="mx-auto w-full max-w-[760px]">
                    {!isMcpConfigured ? (
                      <div className="py-8 text-[14px] text-slate-400">Chưa có thông tin gợi ý.</div>
                    ) : (
                ...
                {(!recentQuestionsError && (recentQuestionsLoading || recentQuestions.length > 0)) && (
                  <div className="mb-2 min-h-0 flex-shrink flex-col overflow-hidden text-left">
                    ...
                    {!isMcpConfigured ? (
                      <div className="py-2 text-[13px] text-slate-400">Chưa có thông tin.</div>
